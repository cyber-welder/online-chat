...
logger = logging.getLogger('client')    # Инициализация клиентского логера
...
class ClientReader(threading.Thread, metaclass=ClientVerifier):
    ...
    def run(self):
        """ Основной цикл приёмника сообщений, принимает сообщения, выводит в консоль. Завершается при потере
        соединения """
        while True:
            try:
